<div id="history-receipt-modal" class="hidden fixed inset-0 z-60 overflow-y-auto bg-black/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4">
    <div class="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden my-auto transform transition-all">
        ...
        <div class="px-6 pt-5 pb-3 flex items-center justify-between border-b border-gray-100 dark:border-gray-700">
            <div class="flex items-center gap-2">
                ...
                <h3 class="text-base font-bold text-gray-900 dark:text-white">Bukti Pembayaran / Struk</h3>
            </div>
            <button type="button" onclick="closeHistoryReceiptModal()" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 p-1 rounded-lg">
        ...
        <div id="history-printable-receipt" class="p-6 bg-gray-50/80 dark:bg-gray-800 font-mono text-xs text-gray-800 dark:text-gray-200 space-y-3">
            ...
            <div class="text-[11px] space-y-1 py-2 border-b border-dashed border-gray-300 dark:border-gray-600">
                <div class="flex justify-between">
                    ...
                    <span id="h-receipt-order-id" class="font-bold">--</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-500 dark:text-gray-400">Waktu:</span>
                    <span id="h-receipt-date">--</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-500 dark:text-gray-400">Pelanggan:</span>
                    <span id="h-receipt-customer" class="font-semibold">--</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-500 dark:text-gray-400">Tipe:</span>
                    <span id="h-receipt-type" class="font-semibold text-orange-600 dark:text-orange-400">--</span>
                </div>
            </div>

            <!-- Items list -->
            <div class="py-2 border-b border-dashed border-gray-300 dark:border-gray-600 space-y-2" id="h-receipt-items">
                <!-- Dynamic -->
            </div>
            ...
            <div class="space-y-1.5 pt-1 text-[11px]">
                <div class="flex justify-between text-gray-600 dark:text-gray-400">
                    <span>Subtotal:</span>
                    <span id="h-receipt-subtotal">Rp 0</span>
                </div>
                <div class="flex justify-between text-gray-600 dark:text-gray-400">
                    <span>Pajak Resto (10%):</span>
                    <span id="h-receipt-tax">Rp 0</span>
                </div>
                <div class="flex justify-between text-sm font-bold text-gray-900 dark:text-white pt-1 border-t border-gray-300 dark:border-gray-600">
                    <span>TOTAL:</span>
                    <span id="h-receipt-total" class="text-emerald-600 dark:text-emerald-400">Rp 0</span>
                </div>
                <div class="flex justify-between text-gray-600 dark:text-gray-400 pt-1">
                    <span>Metode Bayar:</span>
                    <span id="h-receipt-payment" class="font-semibold">--</span>
                </div>
            </div>
        ...
        <div class="p-4 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 flex items-center gap-2.5">
            ...
            <button type="button" onclick="closeHistoryReceiptModal()"
