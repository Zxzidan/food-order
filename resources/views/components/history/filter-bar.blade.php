    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-3 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex items-center flex-wrap gap-1.5 bg-gray-100/80 dark:bg-gray-700/60 p-1 rounded-xl">
            <button type="button" onclick="filterByStatus('all', this)"
                class="history-status-tab px-3 py-1.5 rounded-lg text-xs font-semibold bg-white dark:bg-gray-800 text-orange-600 dark:text-orange-400 shadow-2xs transition cursor-pointer">
                Semua (45)
            </button>
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="flex items-center bg-gray-100 dark:bg-gray-700 p-1 rounded-xl">
                <button type="button" id="btn-view-table" onclick="setViewMode('table')" title="Tampilan Tabel"
                    class="p-1.5 rounded-lg bg-white dark:bg-gray-800 text-orange-600 dark:text-orange-400 shadow-2xs transition cursor-pointer">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3">
        ...
        <div class="lg:col-span-5 relative">
            <input type="search" id="history-search-input" onkeyup="applyHistoryFilters()"
                placeholder=""
                class="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700/70 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white text-xs sm:text-sm rounded-xl focus:ring-2 focus:ring-orange-500 placeholder:text-gray-400" />
        ...
        <div class="lg:col-span-2 relative">
            <select id="history-payment-filter" onchange="applyHistoryFilters()"
                class="w-full appearance-none pl-3 pr-8 py-2.5 bg-gray-50 dark:bg-gray-700/70 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white text-xs sm:text-sm rounded-xl focus:ring-2 focus:ring-orange-500 cursor-pointer">
        ...
        <div class="lg:col-span-3 flex items-center gap-2">
            <input type="date" id="history-date-filter" value="2026-08-22" onchange="applyHistoryFilters()"
                class="w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-700/70 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white text-xs sm:text-sm rounded-xl focus:ring-2 focus:ring-orange-500" />
