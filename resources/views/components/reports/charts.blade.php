<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 bg-white dark:bg-gray-800 p-5 sm:p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-2xs">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
            ...
            <div class="flex items-center gap-2">
                <span class="inline-flex items-center gap-1.5 text-xs text-orange-600 dark:text-orange-400 font-semibold bg-orange-50 dark:bg-orange-950/30 px-2.5 py-1 rounded-lg">
                    <span class="w-2 h-2 rounded-full bg-orange-500 dark:bg-orange-400"></span> Pendapatan
                </span>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-br from-orange-500 to-amber-600 text-white p-5 rounded-2xl shadow-md">
            <h3 class="text-sm font-semibold uppercase tracking-wider text-orange-100">Ringkasan Keuangan Bersih</h3>
            <div class="mt-3 space-y-2 text-xs">
                ...
                <div class="flex justify-between text-orange-100">
                    ...
                    <span class="font-medium text-amber-200">- Rp 450.000</span>
                </div>
                <div class="flex justify-between text-orange-100">
                    <span>Pajak Resto (10%):</span>
                    <span class="font-medium text-white">Rp 2.800.000</span>
                </div>
                <div class="pt-2 border-t border-orange-400/40 flex justify-between text-sm font-bold">
                    <span>Pendapatan Bersih:</span>
                    <span class="text-emerald-200">Rp 25.200.000</span>
                </div>
            </div>
        </div>
    </div>
