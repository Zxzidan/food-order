...
<head>
    ...
    <!-- Google Fonts: Plus Jakarta Sans & Inter (same as landing page) -->
    ...
    <div class="w-full max-w-[340px] mx-auto bg-white rounded-[1.5rem] shadow-xl shadow-ink/5 border border-ink/5 overflow-hidden relative z-10 transition-all hover:shadow-2xl hover:shadow-accent/10">
        ...
        <div class="p-6 sm:p-8">
            ...
            <form action="{{ route('password.update') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="password" class="block font-bold text-ink text-sm mb-1.5">Kata Sandi Baru</label>
                ...
                <div class="mb-6">
                    <label for="password_confirmation" class="block font-bold text-ink text-sm mb-1.5">Konfirmasi Kata Sandi Baru</label>
                    <div class="relative flex items-center">
