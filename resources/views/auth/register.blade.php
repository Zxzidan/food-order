    ...
    <div class="w-full max-w-[360px] mx-auto bg-white rounded-[1.5rem] shadow-xl shadow-ink/5 border border-ink/5 overflow-hidden relative z-10 transition-all hover:shadow-2xl hover:shadow-accent/10">
        ...
        <div class="p-6 sm:p-8">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-3.5">
                    <label for="name" class="block font-bold text-ink text-sm mb-1.5">Nama Lengkap</label>
                ...
                <div class="mb-6">
                    <label for="password_confirmation" class="block font-bold text-ink text-sm mb-1.5">Konfirmasi Kata Sandi</label>
                    <div class="relative flex items-center">
