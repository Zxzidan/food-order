...
<body class="h-full antialiased text-slate-900 flex items-center justify-center font-sans hero-pattern p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-[380px] mx-auto bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative z-10 transition-all hover:shadow-2xl hover:shadow-primary-600/10">
